...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('TTM:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('TTM:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('Welcome to our Tecurity Task Manager! Press ok and Create Your Task')
    }
  }, 1000)
